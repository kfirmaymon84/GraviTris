namespace eval ::optrace {
  variable script "C:/FPGA/FPGA_FUN/GT_Zybo/GT_Zybo.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "create in-memory project" START { }
  ...
  set_property board_part_repo_paths {C:/Users/KfirMaymon/AppData/Roaming/Xilinx/Vivado/2024.1/xhub/board_store/xilinx_board_store} [current_project]
  set_property board_part digilentinc.com:zybo-z7-20:part0:1.1 [current_project]
  set_property design_mode GateLvl [current_fileset]
  set_param project.singleFileAddWarning.threshold 0
OPTRACE "create in-memory project" END { }
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir C:/FPGA/FPGA_FUN/GT_Zybo/GT_Zybo.cache/wt [current_project]
  set_property parent.project_path C:/FPGA/FPGA_FUN/GT_Zybo/GT_Zybo.xpr [current_project]
  set_property ip_output_repo C:/FPGA/FPGA_FUN/GT_Zybo/GT_Zybo.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet C:/FPGA/FPGA_FUN/GT_Zybo/GT_Zybo.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files C:/FPGA/FPGA_FUN/GT_Zybo/GT_Zybo.srcs/sources_1/bd/design_1/design_1.bd
  set_param project.isImplRun false
OPTRACE "read constraints: implementation" START { }
  read_xdc C:/FPGA/FPGA_FUN/GT_Zybo/GT_Zybo.srcs/constrs_1/new/const.xdc
