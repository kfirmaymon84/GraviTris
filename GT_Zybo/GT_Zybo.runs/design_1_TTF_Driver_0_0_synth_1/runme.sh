...
HD_PWD='C:/FPGA/FPGA_FUN/GT_Zybo/GT_Zybo.runs/design_1_TTF_Driver_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_TTF_Driver_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_TTF_Driver_0_0.tcl
